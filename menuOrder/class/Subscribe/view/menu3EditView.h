...
//
//@optional
//- (void)textFieldBeganEditting:(menu3EditView *)view :(UITextField *)textField;
//
//- (void)textFieldEndEditting:(menu3EditView *)view :(UITextField *)textField;
//
//-(void) textshouleBeginEditting:(menu3EditView *)view :(UITextField *)textField withstring:(NSString *)str;
//@end


@interface menu3EditView : UIView<EditViewDelegate>
