...
- (void)initializePageControl {
    ...
    _pageControl = [[UIPageControl alloc] initWithFrame:pageControlFrame];
     ...
     _pageControl.frame=CGRectMake(20, _scrollView.frame.size.height-20, _scrollView.frame.size.width-20, 20);
...
- (void)loadData {
    ...
    _pageControl.currentPageIndicatorTintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"home_page_on.png"]];
    _pageControl.pageIndicatorTintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"home_page_off.png"]];
